...
export type getWorkoutPlanResponseError = (getWorkoutPlanResponse401 | getWorkoutPlanResponse403 | getWorkoutPlanResponse404 | getWorkoutPlanResponse500) & {
  headers: Headers;
};
...
export type getWorkoutDayResponseError = (getWorkoutDayResponse401 | getWorkoutDayResponse403 | getWorkoutDayResponse404 | getWorkoutDayResponse500) & {
  headers: Headers;
};
...
export type startWorkoutSessionResponseError = (startWorkoutSessionResponse401 | startWorkoutSessionResponse403 | startWorkoutSessionResponse404 | startWorkoutSessionResponse409 | startWorkoutSessionResponse422 | startWorkoutSessionResponse500) & {
  headers: Headers;
};
 ...
 */
export const postAi = async (postAiBody: PostAiBody, options?: RequestInit): Promise<postAiResponse> => {
